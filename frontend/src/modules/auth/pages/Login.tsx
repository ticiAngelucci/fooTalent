...
const Login = () => {
  return (
    <div className="flex min-h-screen">
      <section className="hidden lg:block lg:w-2/3 xl:w-1/2 min-h-screen bg-brand-200 relative">
        <img src="/Logo.svg" alt="" className="absolute top-10 left-10"/>
        <p className="mt-42 text-4xl font-semibold px-10 relative z-50"><span className="text-brand-800">Gestiona</span> tus alquileres de forma <span className="text-brand-800">fácil</span> y <span className="text-brand-800">eficiente</span></p>
        <img src={edificio1} alt="" className="w-4xl absolute bottom-0 z-20"/>
      </section>
      <section className="w-full flex flex-col items-center lg:justify-center bg-gradient-to-br from-gray-100 via-white to-gray-200 lg:pt-32 lg:pb-16 min-h-screen">
