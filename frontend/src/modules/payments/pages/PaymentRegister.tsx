...
const PaymentRegister = ({ firstName, address, open, setOpen }: PaymentProps) => {
    return (
            ...
            <DialogContent className="">
                ...
                <DialogHeader className="flex-row gap-8 items-center">
                    <div className="flex flex-col flex-1/2 gap-2.5">
                        ...
                        <span className="w-full py-2 px-3 rounded-sm border text-base border-neutral-300 bg-neutral-100">{firstName}</span>
                    </div>
                    <div className="flex flex-col flex-1/2 gap-2.5">
